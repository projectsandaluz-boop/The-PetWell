        ...
        <div className="lg:w-[55%] p-12 md:p-16 flex flex-col justify-center">
          <div className="max-w-md mx-auto w-full">
            ...
            <form className="space-y-5" onSubmit={handleSignup}>
              ...
              <button 
                disabled={loading}
                className="w-full bg-primary text-on-primary font-bold py-5 rounded-2xl hover:opacity-90 transition-all active:scale-[0.98] shadow-lg shadow-primary/10 flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? "Creating Account..." : "Create Guardian Account"} <ArrowRight className="w-5 h-5" />
              </button>
            </form>
